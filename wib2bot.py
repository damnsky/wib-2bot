...
ki = WIB.LINE() # WIB
ki.login(token="TOKEN WIB")
ki.loginResult()

print "===[Login Success WIB]==="
mulai = time.time()
reload(sys)
...
#//commandnya
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Itu Creator saya manis dan ngangenin kan 😄")
#--------------------------------------------------------
...
#==================================================
            ...
            elif msg.text in ["Join","Wib join","Join all"]:
              if msg.from_ in admin:
...
#--------------------------------------------------------
		...
		if wait["AutoKick"] == True: md+="✔ Autokick : on\n"
                ...
                cl.sendText(msg.to,"===[Status Wib bot]===\n"+md)
#--------------------------------------------------------
